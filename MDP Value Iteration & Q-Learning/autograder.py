...
def evaluate(generateSolutions,
    ...
    for q in test_subdirs:
        ...
        questionDict = testParser.TestParser(os.path.join(
            subdir_path, 'CONFIG')).parse()
    ...
    grades.grade(sys.modules[__name__],
                 ...
                 vocareumLeaderBoardScoreFile=vocareumLeaderBoardScoreFile)
